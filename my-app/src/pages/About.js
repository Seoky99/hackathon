  ...
  return (
    <>
      ...
      <h2 className="paragraph">
        Nearly <span style={{ fontWeight: 'bold', color: 'red' }}> 1.2 trillion </span>
        ...
        water per minute, this is an average of 17 gallons of water used
        for showering per person per day [2].
        <br></br>
        <br></br>
        According to WebMD, you should aim to shower for 3 to 5 minutes.
        This means that an average person showers 3 to 5 minutes longer
        than is recommended. That is 7.5 to 12.5 gallons of water wasted!
        In fact, WebMD does not recommend showering for a long time because
        it can cause cracks in the skin and allow germs to enter. [3]
        <br></br>
        <br></br>
      ...
      <h2 className="paragraph">
        We designed this website to provide a fun and competitive way
        to conserve water during showers with 4 easy steps.
        <br></br>
        <br></br>
        ...
        <br></br> 4) select your playlist and go
        As a bonus, you can check your streak to see how many consecutive days
        you have showered within your target shower time.
      </h2>
      <p className="about-header">
        Does this work?
      </p>
